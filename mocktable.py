...
public class HandlerTest {
    ...
    @Test
    public void testMultipleDependenciesReturned() throws Exception {
        when(objectMapper.readValue(anyString(), eq(DatasetAvailability.class)))
                .thenReturn(new DatasetAvailability("raw", "source", "dataset1", "AVAILABLE", "2025-08-12T17:51:31.770Z"));
    ...
    @Test
    public void testGetParametersByPathWithPagination() {
    ...
    @Test
    public void testGenericExceptionDuringLockAcquisition() throws Exception {
        when(objectMapper.readValue(anyString(), eq(DatasetAvailability.class)))
                .thenReturn(new DatasetAvailability("raw", "source", "dataset1", "AVAILABLE", "2025-08-12T17:51:31.770Z"));

        mockSsmGetParametersByPath(List.of(createParameter("blockingParam")));
        when(dynamoDBLockClient.acquireLock(any())).thenThrow(new RuntimeException("Lock failure"));

        assertThrows(RuntimeException.class, () -> handler.accept(createEvent()));
    }

    @Test
    public void testPutParameterThrowsException() throws Exception {
        when(objectMapper.readValue(anyString(), eq(DatasetAvailability.class)))
                .thenReturn(new DatasetAvailability("raw", "source", "dataset1", "AVAILABLE", "2025-08-12T17:51:31.770Z"));
        ...
        doThrow(new RuntimeException("SSM failure"))
    ...
    @Test
    public void testNullGetParameterResponse() throws Exception {
        when(objectMapper.readValue(anyString(), eq(DatasetAvailability.class)))
                .thenReturn(new DatasetAvailability("raw", "source", "dataset1", "AVAILABLE", "2025-08-12T17:51:31.770Z"));
        ...
        assertThrows(NullPointerException.class, () -> handler.accept(createEvent()));
    }
    ...
    public void testSendTaskSuccessThrowsException() throws Exception {
        ...
        doThrow(new RuntimeException("Step Function error"))
    ...
    @Test
    public void testBlockingParameterWithSpacesInToken() throws Exception {
        when(objectMapper.readValue(anyString(), eq(DatasetAvailability.class)))
                .thenReturn(new DatasetAvailability("raw", "source", "dataset1", "AVAILABLE", "2025-08-12T17:51:31.770Z"));
    ...
    @Test
    public void testGetOutputJsonSerializationFailure() throws Exception {
        doThrow(new JsonProcessingException("write error") {})
                .when(objectMapper).writeValueAsString(any());

        java.lang.reflect.Method method = Handler.class.getDeclaredMethod(
                "getOutputJson", String.class, String.class, String.class, String.class);
        method.setAccessible(true);
        Object result = method.invoke(handler, "dataset", "dependency", "status", "2025-08-12T17:51:31.770Z");
